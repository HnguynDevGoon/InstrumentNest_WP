...
if ( ! class_exists( 'BaseMessages' ) ) {
	...
	class BaseMessages {
		...
		const DLT_TEMPLATE_TITLE      = 'DLT_TEMPLATE_TITLE';
		const FORM_NOT_AVAIL_BODY     = 'FORM_NOT_AVAIL_BODY';
		const DLT_TEMPLATE_BODY       = 'DLT_TEMPLATE_BODY';
		...
		const EMAIL_SENDER_HEADER     = 'EMAIL_SENDER_HEADER';
		const EMAIL_SENDER_BODY       = 'EMAIL_SENDER_BODY';
		...
		const TEMPLATE_RESET          = 'TEMPLATE_RESET';
		...
		const WC_RESET_NO_PHONE        = 'WC_RESET_NO_PHONE';
		...
		const LOW_TRANSACTION_ALERT            = 'LOW_TRANSACTION_ALERT';
		const ZERO_TRANSACTION_ALERT           = 'ZERO_TRANSACTION_ALERT';
		const LOW_TRANSACTION_ERROR            = 'LOW_TRANSACTION_ERROR';
		const NEW_WC_ACCOUNT_NOTIF_HEADER      = 'CUSTOM_WC_NOTIF_BODY';
		const NEW_WC_ACCOUNT_NOTIF_BODY        = 'CUSTOM_WC_NOTIF_SMS';
		const NEW_WC_ACCOUNT_NOTIF_SMS         = 'CUSTOM_WC_NOTIF_MESSAGE';


		const WCFM_DIRECT_MESSAGE_NOTIF_HEADER    = 'WCFM_DIRECT_MESSAGE_NOTIF_HEADER';
		const WCFM_DIRECT_MESSAGE_NOTIF_BODY      = 'WCFM_DIRECT_MESSAGE_NOTIF_BODY';
		const WCFM_NEW_PRODUCT_NOTIF_HEADER       = 'WCFM_NEW_PRODUCT_NOTIF_HEADER';
		const WCFM_NEW_PRODUCT_NOTIF_BODY         = 'WCFM_NEW_PRODUCT_NOTIF_BODY';
		const WCFM_NEW_PRODUCT_NOTIF_SMS          = 'WCFM_NEW_PRODUCT_NOTIF_SMS';
		const WCFM_DIRECT_MESSAGE_NOTIF_SMS       = 'WCFM_DIRECT_MESSAGE_NOTIF_SMS';
		const WCFM_NEW_ORDER_NOTIF_HEADER         = 'WCFM_NEW_ORDER_NOTIF_HEADER';
		const WCFM_NEW_ORDER_NOTIF_BODY           = 'WCFM_NEW_ORDER_NOTIF_BODY';
		const WCFM_NEW_ORDER_NOTIF_SMS            = 'WCFM_NEW_ORDER_NOTIF_SMS';
		const WCFM_LOW_STOCK_PRODUCT_NOTIF_HEADER = 'WCFM_LOW_STOCK_PRODUCT_NOTIF_HEADER';
		const WCFM_LOW_STOCK_PRODUCT_NOTIF_BODY   = 'WCFM_LOW_STOCK_PRODUCT_NOTIF_BODY';
		const WCFM_LOW_STOCK_PRODUCT_NOTIF_SMS    = 'WCFM_LOW_STOCK_PRODUCT_NOTIF_SMS';
		const WCFM_REFUND_REQUEST_NOTIF_HEADER    = 'WCFM_REFUND_REQUEST_NOTIF_HEADER';
		const WCFM_REFUND_REQUEST_NOTIF_BODY      = 'WCFM_REFUND_REQUEST_NOTIF_BODY';
		const WCFM_REFUND_REQUEST_NOTIF_SMS       = 'WCFM_REFUND_REQUEST_NOTIF_SMS';
		const WCFM_PRODUCT_REVIEW_NOTIF_HEADER    = 'WCFM_PRODUCT_REVIEW_NOTIF_HEADER';
		const WCFM_PRODUCT_REVIEW_NOTIF_BODY      = 'WCFM_PRODUCT_REVIEW_NOTIF_BODY';
		const WCFM_PRODUCT_REVIEW_NOTIF_SMS       = 'WCFM_PRODUCT_REVIEW_NOTIF_SMS';

		const PRODUCT_IS_IN_LOW_STOCK_NOTIF_HEADER = 'PRODUCT_IS_IN_LOW_STOCK_NOTIF_HEADER';
		const PRODUCT_IS_IN_LOW_STOCK_NOTIF_BODY   = 'PRODUCT_IS_IN_LOW_STOCK_NOTIF_BODY';
		const PRODUCT_IS_IN_LOW_STOCK_SMS          = 'PRODUCT_IS_IN_LOW_STOCK_SMS';
		...
		const INVALID_ACCOUNT_USERNAME             = 'INVALID_ACCOUNT_USERNAME';
